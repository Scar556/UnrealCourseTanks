...
{
	auto AIForwardIntention = MoveVelocity.GetSafeNormal(); // Getsafenormal gives us a Unit Vector
	auto TankForward = GetOwner()->GetActorForwardVector().GetSafeNormal(); // Gets the direction tank is facing as a unit vector
